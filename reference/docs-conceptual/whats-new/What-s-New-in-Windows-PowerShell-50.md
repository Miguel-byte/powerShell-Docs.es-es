...
Windows PowerShell 5.0 incluye nuevas características importantes las cuales  amplían y mejoran su uso, permitiendo controlar y administrar entornos basados en Windows de forma más sencilla y completa.
